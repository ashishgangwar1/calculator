...
btn_plus = tk.Button(root, text="+", command=lambda: add_to_calculation("+"), width=5, font=("Arial", 14),background="white")
btn_plus.grid(row=3, column=4)
btn_min = tk.Button(root, text="-", command=lambda: add_to_calculation("-"), width=5, font=("Arial", 14),background="white")
btn_min.grid(row=4, column=4)
btn_mul = tk.Button(root, text="X", command=lambda: add_to_calculation("*"), width=5, font=("Arial", 14),background="white")
btn_mul.grid(row=6, column=2)
btn_div = tk.Button(root, text="/", command=lambda: add_to_calculation("/"), width=5, font=("Arial", 14),background="white")
...
btn_equals = tk.Button(root, text="=", command=evaluate_calculation, width=5, font=("Arial", 14), background="red")
btn_equals.grid(row=6, column=4)
btn_clear = tk.Button(root, text="C", command=clear_field, width=5, font=("Arial", 14),background="white")
btn_clear.grid(row=6, column=1)
btn_back_space = tk.Button(root, text="<-", command=back_space, width=5, font=("Arial", 14),background="white")
btn_back_space.grid(row=2, column=4)
btn_dot = tk.Button(root, text=".", command=lambda: add_to_calculation("."), width=5, font=("Arial", 14),background="white")
